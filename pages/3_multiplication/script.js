document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Event Listeners ---
    generateBtn.addEventListener('click', generateProblems); // Renamed for clarity
    ...
    // --- Main Function to Generate All Possible Problems ---
    function generateProblems() { // Renamed for clarity
        ...
        allPossibleProblems.forEach((problem, index) => {
            ...
            // CHANGED: The '-' sign is now an 'x' for multiplication
            const problemString = `(${String(index + 1).padStart(2, ' ')})   ${num1} x ${num2} =`;
    ...
    function generatePDF() {
        ...
        // CHANGED: PDF title is now "Multiplication Worksheet"
        doc.text("Multiplication Worksheet", 105, 15, null, null, "center");                doc.text("Addition Worksheet", 105, 15, { align: "center" });
        ...
        // CHANGED: PDF filename is now "multiplication-worksheet-v4.pdf"
