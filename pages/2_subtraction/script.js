document.addEventListener('DOMContentLoaded', () => {
    ...
    function generatePDF() {
        ...
        // CHANGED: PDF title is now "Subtraction Worksheet"
        doc.text("Subtraction Worksheet", 105, 15, { align: "center" });
        ...
        // CHANGED: PDF filename is now "subtraction-worksheet-v4.pdf"
